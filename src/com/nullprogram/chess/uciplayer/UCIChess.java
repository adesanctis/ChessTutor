...
/**
 * *******************
 * UCIChess API<br> This API help you to communicate with Chess Engine that
 * respect Universal Chess Interface protocol communication.<br> You can with
 * this API, run a chess engine, send him some uci commands and read responses
 * from this engine.<br>
 *
 * Example of use : <br><br> //test with protector chess engine<br> UCIChess
 * uci=new
 * UCIChess("C:\\Users\\tondeur-h.CHV\\Downloads\\Protector_1_6_0\\bin\\Protector_Win32.exe");<br>
 * <br> //ask uci infos<br> System.out.println("======================TEST UCI
 * COMMAND======================");<br> //is uci ok ?<br>
 * System.out.println("uciok = "+uci.get_UciOk(false));<br> //engine name and
 * author(s)<br> System.out.println("Engine Name = "+uci.getEngineName());<br>
 * System.out.println("Engine Author(s) = "+uci.get_EngineAuthor());<br>
 * System.out.println("==================TEST UCI OPTIONS
 * RETRIEVE=================");<br> //number of options in uci engine<br>
 * System.out.println("Numbers of options = "+uci.get_Number_Options());<br>
 * //list all uci options (names, type, values)<br> System.out.format("%-30s
 * %-10s %-20s\n","Name(id)","type","values");<br>
 * System.out.println("------------------------------------------------------------");<br>
 * for (int i=0;i&lt;uci.get_Number_Options();i++)<br> {<br>
 * System.out.format("%-30s %-10s
 * %-20s\n",uci.get_Option(i).getId(),uci.get_Option(i).getType(),uci.get_Option(i).getValues()
 * );<br> }<br> System.out.println("=====================PLAY A SMALL
 * GAME=====================");<br> //is engine ready?<br>
 * System.out.println("isready = "+uci.get_ReadyOk(false));<br> <br> //white
 * play e2e4<br> System.out.println("White play = e2e4");<br>
 * uci.move_FromSTART("e2e4 ",false); <br>
 * System.out.println("-------------------------------------------------------");<br>
 * //is engine ready for next move?<br> System.out.println("isready =
 * "+uci.get_ReadyOk(false));<br> <br> //black move (engine play)<br>
 * uci.send_uci_cmd(UCIChess.GOTHINK); //think for best move<br> String
 * rep=uci.get_BestMove(false); //read response<br>
 * System.out.println("---------------info on best
 * move-----------------------");<br> System.out.println("Number of infos lines
 * = "+uci.get_number_infos());<br> System.out.format("%-50s\n","Info
 * lines");<br>
 * System.out.println("-------------------------------------------------------");<br>
 * for (int i=0;i&lt;uci.get_number_infos();i++)<br> {<br>
 * System.out.format("%-50s\n",uci.get_info(i).getInfo());<br> }<br>
 * System.out.println("-------------------------------------------------------");<br>
 * System.out.println("Black play = "+rep); //draw best move<br>
 * System.out.println("Black ponder = "+uci.get_Ponder()); //best white next
 * move<br> uci.move_FromSTART("e2e4 "+rep,false); //make move<br>
 * System.out.println("-------------------------------------------------------");<br>
 * <br> //is engine ready for next move?<br> System.out.println("isready =
 * "+uci.get_ReadyOk(false));<br> <br> //white play g1f3<br>
 * System.out.println("White play = g1f3");<br> uci.move_FromSTART("e2e4 "+rep+"
 * g1f3 ",false);<br>
 * System.out.println("-------------------------------------------------------");<br>
 * //is engine ready for next move?<br> System.out.println("isready =
 * "+uci.get_ReadyOk(false));<br> <br> //black play<br>
 * uci.send_uci_cmd(UCIChess.GOTHINK); //search next move<br> String
 * rep2=uci.get_BestMove(false); //read best move<br>
 * System.out.println("---------------info on best
 * move-----------------------");<br> System.out.println("Number of infos lines
 * = "+uci.get_number_infos());<br> System.out.format("%-50s\n","Info
 * lines");<br>
 ...
 * System.out.println("Black ponder = "+uci.get_Ponder()); //best white next
 * move<br> uci.move_FromSTART("e2e4 "+rep+" g1f3 "+rep2,false); //make move<br>
 * Square.convert("g1f3");<br> System.out.println(Square.getColFrom());<br>
 ...
 * System.out.println("-------------------------------------------------------");<br>
 * //bye bye...stop the chess engine<br> System.out.println("Bye Bye!");<br>
 * uci.stop_Engine();<br> <br>
 *
...
public class UCIChess {
    ...
    final private List<UciListener> listeners = new ArrayList<UciListener>();

    /**
     * *************************
     * construct the API UCIChess<br> Start the chess engine in a ProcessBuilder
     * and connect in and out streams communications with this process.<br>
     *
     * @param engine is the full absolute path of the chess engine<br> Make sure
     * you are using a engine that implement an uci protocol.
     * *************************
     */
    public UCIChess(String engine) {
        try {
            ...
            //prepare optionsList
            listOfOptions = new ArrayList<OptionName>();
            //prepare simple line info list
            listInfoSimple = new ArrayList<InfoSimple>();

            //prepare detailed info list
            listInfoDetail = new ArrayList<InfoDetailed>();
...
//            }
    ...
    /**
     * ***************************************
     * Send some moves commands from a FEN format to chess engine<br> FEN format
     * example : rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1<br>
     * see Notation Forsyth-Edwards (FEN) format<br>
     *
     * @param fen A String that give the board state in fen format.
     * @param moves A list of moves in Algebraic Notation format ie e2e4
     * separate by space.
    ...
    /**
     * ***************************************
     * This Method, tell engine to think on a new game position.<br> see UCI
...
//======================SIMPLY SEND COMMANDS====================        
    /**
     * *******************************
     * Send simple command to chess engine<br> like go, uci, isready, position
     * etc...<br> See uci commands documentations for more informations.
     *
...
//========================ENGINE STATES==============================
    ...
    /**
     * ***************************
     * Check if uci engine is ok and ready<br> you must run this method before
     * get name and author of the chess engine and get supported options<br>
     * This method must be the first execute after instanciate the UCIChess
     * object.
     *
     * @param trace A boolean that print the full trace of the Chess engine
     * Responses.
        ...
        try {
            while ((line = in.readLine()) != null) {
                ...
                try { //parser ligne id
                    ...
                    parse_Option(line);
                    // find name engine
                    if (sc.findInLine("id name") != null) {
                        engineName = sc.nextLine();
                    }
                    // find author engine
                    if (sc.findInLine("id author") != null) {
                        engineAuthor = sc.nextLine();
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
    ...
    /**
     * *************************************
     * Return the name of the running engine.<br> This method must be run only
     * after the UCI command.<br> Instead of, this method return NoName or empty
     * string.
     *
    ...
    /**
     * *************************************
     * Return the name(s) of the author(s) of the running chess engine you must
     * execute the uci command before
     *
    ...
    /*
     * ******************************************
     * parse option response from Engine and construct a ArrayList<OptionName>
     * objects @param line *****************************************
     */
    ...
    /**
     * *************************
     * Return the max number of options supported by the engine.<br> You must
     * execute the uci command before used this method.
     *
    ...
    /**
     * ************************
     * Return an option supported by the engine by is number.<br> OptionName
     * class is a bean for manipulate Options.<br> This class contain 3
     * methods<br> String getId(); retrieve the name of the option<br> String
     * getType(); retrieve the type of the option<br> String getValues();
     * retrieve the default and possibles values for this option<br> <br> This
     * Method must be call only after a uci command.<br> <br>
     *
     * @param Number A integer identified the option number in the list of
     * options.
    ...
    public OptionName get_Option(int Number) {
        ...
        if (Number >= listOfOptions.size()) {
            return null; //number must begin from 0 to size-1
        }
    ...
    /**
     * ***********************************
     * set option name for option with no value, like "Clear Hash" for example.
     *
    ...
    /**
     * ************************************
     * set option name for option with values, like "Nullmove" waiting for a
     * boolean value true/false for example.
     *
     * @param id Is the name of the option.
...
//======================ENGINE THINKING==============================
    /**
     * ***************************************
     * This Method, make the engine searching the bestmove and return it as soon
     * as possible ***************************************
     */
     ...
     * ***************************************
     * This Method, make the engine searching the bestmove and return it as soon
     * as possible when the depth search is reaching.
     *
     ...
     * ***************************************
     * This Method, make the engine searching the bestmove and return it as soon
     * as possible when the number of calculating nodes search is reach.
     *
    ...
    public void go_Think_Nodes(long nodes) {
        ...
        if (nodes > 100000000) {
            nodes = 100000000; //max 100000000 nodes
        }
     ...
     * ***************************************
     * This Method, make the engine searching the bestmove and return it as soon
     * as possible when the "mate in x turns" search is reaching.
     *
    ...
    public void go_Think_Mate_In(int mateIn) {
        if (mateIn < 1) {
            mateIn = 1; //min in one turns
        }
        if (mateIn > 500) {
            mateIn = 500; //max in 500 turns
        }
    ...
    public void go_Think_MoveTime(long miliSec) {
        if (miliSec < 1) {
            miliSec = 1; //min 1 milisecond
        }
        if (miliSec > (120 * 60 * 1000)) {
            miliSec = (120 * 60 * 1000); //max 2 hours
        }
    ...
    /**
     * ***************************************
     * This Method, make the engine searching the bestmove and return it in a
     * infinite time... ***************************************
     */
    ...
    /**
     * ***************************************
     * This Method, make the engine searching in pondering mode and return it in
     * a infinite time... ***************************************
     */
    ...
    /**
     * *********************************
     * Ask the best move calculate by the chess engine.<br> This method can only
     * be uses after a GO command.
     *
    ...
    public boolean is_opponent_Mated(boolean trace) {
        ...
        if (trace) {
            System.out.println("score mate=" + getMate);
        }
    ...
    private void parse_Info_Line(String line) {
        ...
        while (sc.hasNext()) {
            ...
            if (sc.hasNext()) {
                value = sc.next(); //read next value if possible
            }
        } //end while
    ...
    /**
     * *********************************
     * Method used for internal use call by parse_Info_Line() test if val is a
     * know word => so it is a key
     *
     * @param val
     * @return *********************************
     */
    ...
    /**
     * *************************************
     * Return the ponder value after a GO command.<br> This method must be run
     * only after a GO command.
     *
     * @return A String contains the ponder values or "mate" key if a mate is
     * reach. *************************************
     */
    ...
    /**
     * *************************
     * Return the max number of infos after a GO command.<br> You must execute
     * the GO command before used this method.
     *
     * @return An integer containing the count return. *************************
     */
    ...
    /**
     * ************************
     * Return an info line by is number from the responses engine after a GO
     * command.<br> Info class is a bean for manipulate Infos lines.<br> This
     * class contain 1 method<br> String getInfo(); retrieve the String info<br>
     * <br> This Method must be call only after a GO command.<br> <br>
     *
     * @param Number A integer identified the info line number in the list of
     * infos.
    ...
    /**
     * ************************
     * Return some detailed infos line by is number from the responses engine
     * after a GO command.<br> InfoDetailed class is a bean for manipulate Infos
     * structures.<br> <br> This Method must be call only after a GO
     * command.<br> <br>
     *
     * @param Number A integer identified the info line number in the list of
     * infos.
    ...
    private void updateListeners(InfoDetailed details) {
        for (UciListener listener : listeners) {
            listener.engineUpdate(details);
        }
    }
...
//===============================BEANS CLASS DEFINITIONS==========================    
    ...
    public final class OptionName {
        ...
        /**
         * Return the values default value, and min and max values for this
         * option if so!
         *
    ...
    /**
     * ******************
     * class for managed Infos return by a GO command wich is a simple line
     * return
     *
     * @author tondeur-h ******************
     */
