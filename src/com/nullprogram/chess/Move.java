...
public final class Move implements Serializable {
    ...
    private String analyzedMoves;

    public Move(final String move) {
        destination = new Position(move.substring(2));
    ...
    /**
     * @return the analyzedMoves
     */
    public String getAnalyzedMoves() {
        return analyzedMoves;
    }

    /**
     * @param analyzedMoves the analyzedMoves to set
     */
    public void setAnalyzedMoves(String analyzedMoves) {
