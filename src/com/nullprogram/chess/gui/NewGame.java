...
import com.nullprogram.chess.uciplayer.UciPlayer;
...
public class NewGame extends JDialog implements ActionListener {
    ...
    private final UciPlayerSelector whitePanel;

    /** Black player selector. */
    private final UciPlayerSelector blackPanel;
    ...
    public NewGame(final ChessFrame owner) {
        ...
        whitePanel = new UciPlayerSelector("White:", true);
        blackPanel = new UciPlayerSelector("Black:", false);
...
//            return new MiniMax(game, name);
            return new UciPlayer(Integer.parseInt(name.substring(6)),game);
        }
    }
